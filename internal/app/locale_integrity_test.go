...
var referencedLocaleKey = regexp.MustCompile(`"((?:auth|cookie|create|demo|edit|error|events|footer|forgot_password|guides|landing|legal|login|nav|overview|payment_success|poster|pricing|register|site|upload)\.[a-zA-Z0-9_.%]+)"`)
